...
export const ProductCard = ({ product, index = 0 }) => {
  ...
  return (
    <motion.div
      ...
      className="h-full"
    >
      <div className="group bg-white dark:bg-neutral-900 border border-gray-200 dark:border-neutral-800 rounded-2xl overflow-hidden transition duration-300 hover:shadow-2xl hover:-translate-y-1 hover:border-neutral-400 dark:hover:border-neutral-500 flex flex-col h-full">
        <Link
